...
function createTemporaryBindingIfNotDefined(binding, type, injector) {
    if (binding === undefined) {
        if (typeof type === 'string') {
            throw new Error('Trying to bind implicitly, but got type name instead of type for ' + type + '. ' + 'Implicit binding is only possible if type was added to module. Use module.bind() to bind it.');
        }
        binding = {
